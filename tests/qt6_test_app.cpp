...
public:
    TestWindow(QWidget *parent = nullptr) : QMainWindow(parent) {
        setWindowTitle("QtWebDriver Qt 6 Test Application");
        ...
        // Title
        QLabel *titleLabel = new QLabel("QtWebDriver Qt 6 Test Application", this);
...
private slots:
    void onHelloClicked() {
        resultLabel->setText("Hello from Qt 6 QtWebDriver!");
    }
