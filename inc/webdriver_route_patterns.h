...
public:
    ...
    static const char kGetWindowHandlesW3C[];  // W3C WebDriver alias
    static const char kWindowCmd[];
    static const char kGetPageSource[];
    static const char kUrlCmd[];
    static const char kExecuteScript[];
    static const char kExecuteScriptW3C[];  // W3C WebDriver alias
    static const char kExecuteAsyncScript[];
    static const char kExecuteAsyncScriptW3C[];  // W3C WebDriver alias
    static const char kGetAppCache[];
    static const char kBrowserConnection[];
    static const char kAlertText[];
    static const char kAlertTextW3C[];  // W3C WebDriver alias
    static const char kAcceptAlert[];
    static const char kAcceptAlertW3C[];  // W3C WebDriver alias
    static const char kDismissAlert[];
    static const char kDismissAlertW3C[];  // W3C WebDriver alias
    static const char kMaximizeWindowW3C[];  // W3C WebDriver alias
