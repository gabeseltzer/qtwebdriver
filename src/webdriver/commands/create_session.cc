...
void CreateSession::ExecutePost(Response* const response) {
    ...
    // This works with both Selenium 3 (JSONWire) and Selenium 4 (W3C)
    ...
    // Set the response value with session data
    response->SetValue(session_data);
    // Return 200 OK instead of 303 redirect for W3C compatibility
